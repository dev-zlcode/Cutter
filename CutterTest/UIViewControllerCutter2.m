...
#import "UIViewControllerCutter2.h"

@interface UIViewControllerCutter2 ()

@end

@implementation UIViewControllerCutter2
...
- (void)rightButton:(UIButton *)sender
{
    ...
    vc.image = [self.navigationController.view viewCutter];
